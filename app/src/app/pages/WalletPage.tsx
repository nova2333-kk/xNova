...
import { SessionManager, WalletService } from '@/services/wallet';
      ...
      <div className="px-4 pt-4 pb-4">
        <div className="mb-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button onClick={handleRefresh} className="rounded-full p-2 text-slate-500 hover:bg-slate-100" title="刷新">
