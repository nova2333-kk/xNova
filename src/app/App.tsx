...
import { MnemonicService, SecureStorage, SessionManager } from '@/services/wallet';
...
export function App() {
  ...
  const openFlow = (flow: FlowView) => setView(flow);
  ...
  const renderCurrentView = () => {
    switch (view) {
      case 'home':
        return <HomePage onCreateWallet={() => openFlow('createWallet')} onSetPassword={() => openFlow('setPassword')} />;
      case 'apps':
        return <AppsPage />;
      case 'friends':
        return <FriendsPage />;
